...
const factsDatabase = {
  trueFacts: [
    ...
    { id: 10, fact: "Ocean plankton produce roughly half of the oxygen in Earth's atmosphere", category: "nature" },
    ...
    { id: 18, fact: 'The human nose has about 400 different types of smell receptor', category: "biology" },
    ...
    { id: 21, fact: 'Elephants cannot jump, and neither can sloths, hippos or rhinos', category: "biology" },
    ...
    { id: 35, fact: 'A single sneeze can send a cloud of droplets up to 8 meters across a room', category: "biology" },
    ...
    { id: 45, fact: 'The human body produces about 3.8 million new cells each second, mostly blood cells', category: "biology" },
    ...
    { id: 70, fact: 'The longest verified reign of any monarch was Sobhuza II of Swaziland at 82 years', category: "history" },
    ...
    { id: 94, fact: 'Istanbul is the largest city in the world that sits on two continents', category: "geography" },
    ...
    { id: 99, fact: 'More people live in the Tokyo metropolitan area than in the whole of Australia', category: "geography" },
    ...
    { id: 109, fact: 'Sweden has more islands than any other country, roughly 267,000 of them', category: "geography" },
    ...
    { id: 131, fact: 'In 1947 engineers taped a moth found in the Harvard Mark II computer into their logbook as a joke', category: "technology" },
    ...
    { id: 137, fact: 'Wi-Fi is a brand name invented by a marketing agency and does not actually stand for anything', category: "technology" },
    ...
    { id: 140, fact: "'123456' is still one of the most commonly used passwords in the world", category: "technology" },
    ...
    { id: 158, fact: "Thomas Edison was using the word 'bug' for a technical fault as early as 1878", category: "technology" },
